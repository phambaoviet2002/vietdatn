                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                                    ...
                                                                    <h1
                                                                        ...
                                                                        Xs
                                                                        <span>{{ $du_lieu['ho_va_ten'] }} </span></h1>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                        ...
                                                        <table
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-l" bgcolor="#ffffff"
                                                                    ...
                                                                    <h2>Quý khách đã gửi đến Shop Gucci với nội dung như sau :</h2>
                                                                    <h2>Tiêu Đề : <b>{{ $du_lieu['tieu_de'] }}</b></h2>
                                                                    <h2>Nội dung đóng góp Ý Kiến & Hổ Trợ: <p>{{ $du_lieu['noi_dung'] }}</p>
                                                                    </h2>
                                                                    </p>
                                                                </td>
                                                            </tr>
